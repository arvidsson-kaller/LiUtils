...
(async () => {
    ...
    assert(courseLink === 'https://cloud.timeedit.net/liu/web/schema/objects.html?partajax=t&sid=3&objects=&types=219&fe=132.0&max=1&search_text=tddd27');
    ...
    assert(url === 'https://cloud.timeedit.net/liu/web/schema/ri107826X55Z04Q6Z56g3Y80y0046Y53201gQY6Q55.html');
