...
import { ecvLabel, specLabel } from "@/lib/master/helpers";
...
function Block({
  ...
  return (
    ...
    >
      ...
      >
        <Button
          onClick={() => onAddCourse(block, period)}
          variant="contained"
          sx={{
            width: "100%",
            height: "100%",
  ...
  return (
    <>
      <Typography>
        ...
        >
          <span style={{textDecoration: "underline"}} color={"inherit"}>{course.courseCode}</span>
        </NextLink>
        : {course.courseName}
      </Typography>
      <Box
